...
dependencies {
    ...
    implementation(dependencyNotation = "androidx.compose.material:material-icons-extended:1.2.0-alpha03")
    ...
    androidTestImplementation(dependencyNotation = "androidx.compose.ui:ui-test-junit4:1.2.0-alpha03")
    debugImplementation(dependencyNotation = "androidx.compose.ui:ui-tooling:1.2.0-alpha03")
}